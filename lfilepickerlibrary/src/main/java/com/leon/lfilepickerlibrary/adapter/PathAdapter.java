...
public class PathAdapter extends RecyclerView.Adapter<PathAdapter.PathViewHolder> {
    ...
    class PathViewHolder extends RecyclerView.ViewHolder {
        ...
        public PathViewHolder(View itemView) {
            super(itemView);
            ivType = (ImageView) itemView.findViewById(R.id.fp_iv_type);
            layoutRoot = (RelativeLayout) itemView.findViewById(R.id.fp_layout_item_root);
            tvName = (TextView) itemView.findViewById(R.id.fp_tv_name);
            tvDetail = (TextView) itemView.findViewById(R.id.fp_tv_detail);
            cbChoose = (CheckBox) itemView.findViewById(R.id.fp_cb_choose);
        }
    }
}
