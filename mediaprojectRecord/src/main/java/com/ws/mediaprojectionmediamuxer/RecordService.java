...
public class RecordService extends Service {
    ...
    private void createEnvironment() {
        mVideoPath = Environment.getExternalStorageDirectory().getPath() + "/Video/";
        mMpmngr = MyApplication.getMpmngr();
    ...
    private void createFloatView() {
        ...
        final WindowManager.LayoutParams params = new WindowManager.LayoutParams(LAYOUT_FLAG, WindowManager.LayoutParams.FLAG_NOT_FOCUSABLE, PixelFormat.RGBA_8888);
    ...
    private void setUpMediaProjection() {
        ...
        Intent data = MyApplication.getResultIntent();
