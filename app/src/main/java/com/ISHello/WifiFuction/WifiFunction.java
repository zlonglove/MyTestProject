package com.ISHello.WifiFuction;
...
public class WifiFunction {
    ...
    public static WifiFunction Instance(Context context) {
        if (wifiFunction == null) {
            wifiFunction = new WifiFunction(context);
        }
        return wifiFunction;
    }
    ...
    public Object getField(Object obj, String name) throws SecurityException,
    ...
    public void set_static(String SSID, String static_ip,
                           String static_gateway, String static_dns) {
