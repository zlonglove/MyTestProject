package com.ISHello.RectEdittext;
        ...
        for (int i = 0; i < n; i++) {
            ...
            switch (attr) {
                case R.styleable.RectangleBoxEditText_boxBackgroundColor:
                    boxBackgroundColor = a.getColor(R.styleable.RectangleBoxEditText_boxBackgroundColor, Color.RED);
                    break;
                case R.styleable.RectangleBoxEditText_boxStokeColor:
                    boxStokeColor = a.getColor(attr, Color.GRAY);
                    break;
                case R.styleable.RectangleBoxEditText_numberTextColor:
                    numberTextColor = a.getColor(attr, Color.BLACK);
                    break;
                case R.styleable.RectangleBoxEditText_boxCount:
                    boxNumber = a.getInt(attr, 6);
                    break;
                case R.styleable.RectangleBoxEditText_boxPadding:
                    boxPadding = a.getDimensionPixelSize(attr, 0);
                    break;
            }
        }
        a.recycle();
