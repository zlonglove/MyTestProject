...
public abstract class ViewAware implements ImageAware {
    ...
    private final static String TAG = "ViewAware";
    public static final String WARN_CANT_SET_DRAWABLE = "Can't set a drawable into view. You should call ImageLoaderActivity on UI thread for it.";
    public static final String WARN_CANT_SET_BITMAP = "Can't set a bitmap into view. You should call ImageLoaderActivity on UI thread for it.";
    ...
    /**
     * Constructor. <br />
     * References {@link #ViewAware(android.view.View, boolean)
     ...
     *                            {@link #getHeight()} will check actual size of View. It can
     *                            cause known issues like But it helps to save memory because memory cache
     ...
     *                            View, just layout parameters. <br />
     ...
     * {@inheritDoc}
     * <p/>
     * Width is defined by target {@link android.view.View view} parameters,
     ...
     * {@inheritDoc}
     * <p/>
     * Height is defined by target {@link android.view.View view} parameters,
     * configuration parameters or device display dimensions.<br />
     * Size computing algorithm (go by steps until get non-zero value):<br />
