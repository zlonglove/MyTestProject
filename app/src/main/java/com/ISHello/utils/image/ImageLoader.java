package com.ISHello.utils.image;
...
public class ImageLoader {
     ...
     * 默认线程池个数
     */
    private static final int DEAFULT_THREAD_COUNT = 4;
    /**
     * 队列的调度方式,栈的方式，先进后出
     */
    ...
    private void initBackThread() {
        // 后台轮询线程
        handlerThread = new HandlerThread("imageLoad looper");
        handlerThread.start();
        mPoolThreadHandler = new Handler(handlerThread.getLooper()) {
            @Override
