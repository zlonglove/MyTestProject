...
public class TallyDetailAdapter extends StickyHeaderGridAdapter {
    ...
    public void onBindItemViewHolder(ItemViewHolder viewHolder, final int section, final int position) {
        ...
        GlideUtils.getInstance().LoadContextBitmap(mContext, baseUrl + mDatas.get(section).getList().get(position).getImg(),
                holder.item_img, R.drawable.head, R.drawable.head, null);
