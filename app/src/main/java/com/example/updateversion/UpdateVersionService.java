...
public class UpdateVersionService {
        ...
        public void handleMessage(Message msg) {
            ...
            switch ((Integer) msg.obj) {
                case DOWN:
                    ...
                    break;
                case DOWN_FINISH:
                    CustomToast.makeText(context, "文件下载完成,正在安装更新", Toast.LENGTH_SHORT);
                    installAPK();
                    break;
    ...
    public void checkUpdate() {
        if (isUpdate()) {
            ...
            CustomToast.makeText(context, "已经是新版本", Toast.LENGTH_SHORT);
        }
    }
    ...
    private boolean isUpdate() {
        ...
        if (null != hashMap) {
            ...
            if (serverCode > versionCode) {
                CustomToast.makeText(context, "新版本是: " + serverCode, Toast.LENGTH_SHORT);
                return true;
            }
        }
        return false;
    ...
    private int getVersionCode(Context context2) {
        ...
        try {
            ...
            CustomToast.makeText(context, "当前版本是: " + versionCode, Toast.LENGTH_SHORT);
