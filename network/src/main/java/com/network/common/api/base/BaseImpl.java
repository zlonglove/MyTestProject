...
import com.network.common.api.converter.StringConverterFactory;
...
public class BaseImpl<Service> {
    ...
    public BaseImpl(String baseUrl, int currentParse) {
        if (null != mRetrofit && mService != null && this.currentParse == currentParse && this.currentBaseUrl.equals(baseUrl)) {
            return;
        }
