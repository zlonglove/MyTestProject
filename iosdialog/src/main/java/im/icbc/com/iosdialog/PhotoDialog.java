...
public class PhotoDialog extends DialogFragment {
    ...
    private void initView(View photoView) {
        tvTakeCamera = (TextView) photoView.findViewById(R.id.tv_take_camera);
        tvChoosePhoto = (TextView) photoView.findViewById(R.id.tv_choose_photo);
        tvCancel = (TextView) photoView.findViewById(R.id.tv_cancel);
