...
public class HintDialog extends DialogFragment {
    ...
    private void initView(View hintView) {
        ...
        if (isSingleButton) {
            ...
            tvSingleTextView = (TextView) hintView.findViewById(R.id.tv_single);
            ...
            tvCancelTextView = (TextView) hintView.findViewById(R.id.btn_hint_dialog_cancle);
            tvConfirmTextView = (TextView) hintView.findViewById(R.id.btn_hint_dialog_confirm);
