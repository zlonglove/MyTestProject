package com.in.zlonglove.commonutil.ui.dialog;
...
import com.in.zlonglove.commonutil.R;
...
public class DialogFragmentHelper {
     ...
     * 加载中的弹出窗
     */
    private static final int PROGRESS_THEME = R.style.CommonUtil_Base_AlertDialog;
     ...
     * 简单提示弹出窗
     */
    private static final int TIPS_THEME = R.style.CommonUtil_Base_AlertDialog;
    ...
    public static void showTips(FragmentManager fragmentManager, String message) {
        showTips(fragmentManager, message, true);
    }
    ...
    public static void showTips(FragmentManager fragmentManager, final String message, boolean cancelable, CommonDialogFragment.OnDialogCancelListener cancelListener) {
        CommonDialogFragment dialogFragment = CommonDialogFragment.newInstance(new CommonDialogFragment.OnCallDialog() {
            @Override
            public Dialog getDialog(Context context) {
     ...
     * 确定取消框
     */
    private static final int CONFIRM_THEME = R.style.CommonUtil_Base_AlertDialog;
     ...
     * 带列表的弹出窗
     */
    private static final int LIST_THEME = R.style.CommonUtil_Base_AlertDialog;
     ...
     * 选择日期
     */
    private static final int DATE_THEME = R.style.CommonUtil_Base_AlertDialog;
     ...
     * 选择时间
     */
    private static final int TIME_THEME = R.style.CommonUtil_Base_AlertDialog;
     ...
     * 带输入框的弹出窗
     */
    private static final int INSERT_THEME = R.style.CommonUtil_Base_AlertDialog;
     ...
     * 带输入密码框的弹出窗
     */
    private static final int PASSWORD_INSER_THEME = R.style.CommonUtil_Base_AlertDialog;
     ...
     * 两个输入框的弹出窗
     */
    private static final int INTERVAL_INSERT_THEME = R.style.CommonUtil_Base_AlertDialog;
