package com.in.zlonglove.commonutil;
...
public class AppFileMgr {
    ...
    //存储图片目录路径
    public static final String CACHE_IMAGE_PATH = "zhanglong/cache/others/images/";

    //存储主页播放图片目录路径
    public static final String CACHE_MAIN_GALLERY_IMAGE_PATH = "zhanglong/cache/gallery/images/";

    //存放用户选择头像目录路径
    public static final String CACHE_CHOOSE_HEAD_PATH = "zhanglong/cache/head/images/";

    //菜单操作按钮缓存目录路径
    public static final String CACHE_APP_ICON_IMAGES_PATH = "zhanglong/cache/app/icon/images/";

    //存储浏览图片目录
    public static final String CACH_BROWSE_PATH = "zhanglong/cache/browse/images/";
     ...
     * @param out
     */
    public static void closeIO(FileChannel in, FileChannel out) {
        if (in != null) {
            try {
                in.close();
            } catch (IOException e) {
