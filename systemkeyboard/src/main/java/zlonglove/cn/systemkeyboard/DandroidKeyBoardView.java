...
public class DandroidKeyBoardView extends KeyboardView {
    private Context mContext;
    private Keyboard mKeyBoard;

    public DandroidKeyBoardView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mContext = context;
    }

    public DandroidKeyBoardView(Context context, AttributeSet attrs, int defStyle) {
